      ...
      <div className="flex pt-16 pb-8 md:pt-12 md:pb-24 justify-center">
        ...
        <div className="lg:max-w-[50%]">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 text-lg">
            <Link
              href="#"
              className="text-black-200 rounded-md p-4 font-semibold  hover:shadow-lg transition duration-500 ease-in-out transform hover:-translate-y-0.5 hover:scale-105  dark:text-black bg-blue-100 shadow-md"
            >
              Start your project
            </Link>
            <Link
              href="/portfolio"
              className="text-black-200 rounded-md p-4 bg-blue-100 font-semibold shadow-md hover:bg-blue-400 
